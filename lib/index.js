...
const url$2 = process.env.LOCATION_URL;
const port$2 = process.env.LOCATION_PORT;
const entryPoint$2 = process.env.LOCATION_ENTRY;
...
const url$3 = process.env.LODGINGI_URL;
const port$3 = process.env.LODGINGI_PORT;
const entryPoint$3 = process.env.LODGINGI_ENTRY;
...
const url$4 = process.env.LODGING_URL;
const port$4 = process.env.LODGING_PORT;
const entryPoint$4 = process.env.LODGING_ENTRY;
...
const url$5 = process.env.RESERVATION_URL;
const port$5 = process.env.RESERVATION_PORT;
const entryPoint$5 = process.env.RESERVATION_ENTRY;
...
//const URL = `http://${url}:${port}/${entryPoint}`;
const URL$6 = `http://3.132.9.148:3045/api/v1/payment`;

const Bresolvers = {
	Query: {
		paymentById: (_, { user_id }) =>
			generalRequest(`${URL$6}/${user_id}`, 'GET'),
	},
	Mutation: {
		createPayment: (_, { payment }) =>
			generalRequest(`${URL$6}`, 'POST', payment),
		updatePayment: (_, { id, payment }) =>
			generalRequest(`${URL$6}/${id}`, 'PUT', payment)
	}
};
