...
//const URL = `http://${url}:${port}/${entryPoint}`;
const URL$6 = `http://3.133.13.240:3010/api/v1/reservation`;
...
const entryPointLa = process.env.LDAP_ENTRYLa;
// agregar usuarios
...
const URLLa = `http://${url$8}:${port$8}/${entryPointLa}`;
const URLAdu = `http://${url$8}:${port$8}/${entryPointAdu}`;
const URLAda = `http://${url$8}:${port$8}/${entryPointAda}`;
